 ...
 * + CACHE_TYPE &ndash; Тип кэширования компонента. Допустимые значения: "A" &ndash; автоматическое
 * и управляемое кэширование, "Y" &ndash; стандартное кэширование, "N" &ndash; без кэширования.
 * По умолчанию "A".
